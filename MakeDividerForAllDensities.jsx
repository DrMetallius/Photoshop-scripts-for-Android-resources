...
if (outputFolder) {
	...
	saveInFolder(outputFolder, "drawable-mdpi", 100, "", ninePatchLines);
	saveInFolder(outputFolder, "drawable-hdpi", 100, "", ninePatchLines);
	saveInFolder(outputFolder, "drawable-xhdpi", 200, "", ninePatchLines);
	saveInFolder(outputFolder, "drawable-xxhdpi", 200, "", ninePatchLines);
}